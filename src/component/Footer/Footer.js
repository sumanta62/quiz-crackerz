    ...
    return (
        <div>
            <footer className="p-6 bg-slate-900">
                <div className="container  text-white px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                    <div className="grid grid-cols-12">
                        <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
                            <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
                                ...
                                <span className="self-center text-2xl font-semibold">Quizzes Web Template</span>
                            </a>
                        </div>
                        <div className="col-span-6 text-center md:text-left md:col-span-3">
                            ...
                            <ul>
                                <li>
                                    <a rel="noopener noreferrer" to='/home' className="hover:dark:text-violet-400">Home</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" to='/topic' className="hover:dark:text-violet-400">Topic</a>
                                </li>
                        ...
                        <div className="col-span-6 text-center md:text-left md:col-span-3">
                            ...
                            <ul>
                                <li>
                                    <a rel="noopener noreferrer" to='/static' className="hover:dark:text-violet-400">Static</a>
                                </li>
                                <li>
                                    <a rel="noopener noreferrer" to='/blog' className="hover:dark:text-violet-400">Blog</a>
                                </li>
                    ...
                    <div className="grid justify-center pt-6 lg:justify-between">
                        <div className="flex flex-col self-center text-sm text-center md:block lg:col-start-1 md:space-x-6">
                            <span>Copy©2022 All rights Quizzes Web Template</span>
